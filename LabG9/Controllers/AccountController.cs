...
namespace LabG9.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, nombreCompleto=model.nombreCompleto,numTelefono=model.numTelefono,direccionEntrega=model.direccionEntrega };
